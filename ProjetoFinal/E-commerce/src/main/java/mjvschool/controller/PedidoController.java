...
public class PedidoController {
	...
	public ResponseEntity alterartem(@PathVariable ("idPedido") Integer idPedido,
		...
		ItemPedido itemPedido = itemPedidoRepository.findById(idItem).orElse(null);
		if (itemPedido  == null) {
			return ResponseEntity.status(HttpStatus.PRECONDITION_FAILED).body("Item Pedido invalido");			
		}
